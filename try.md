...
>[巨量資料分析＿第一次作業] Data Collection and Persistence, 利用 TwitterAPI 抓取 1GB 
> JSON 格式的資料，並使用 Markdown 撰寫 Readme.md

> 程式碼包含 TwitterAPI_New.py 以及 PersistingIO.py 與 PersistingIO.pyc

data資料夾中有兩個檔案
> JSON_Output.json是搜尋Tweet後寫入資料的JSON檔，
> m10409106.log 紀錄抓取過程的 log檔
...
#### 1. 資料來源
    Twitter
#### 2. 資料主題
    "MLB and 12 teams" (美國職棒大聯盟以及其中的12隊隊名)
#### 3. 查詢關鍵字
```
    "MLB", "Yankees", "RedSox", "BlueJays", "Orioles", "Royals", "WhiteSox", "Mariners", "Dodgers", "Phillies", "Rockies", "Mets", "Cubs", "Reds"
```
